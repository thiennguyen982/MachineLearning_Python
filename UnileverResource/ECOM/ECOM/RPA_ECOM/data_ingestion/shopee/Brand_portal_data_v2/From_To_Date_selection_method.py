...
#x_paths
from_date_month_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'    
from_date_year_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[2]'
from_date_month_tab_click1 = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
to_date_month_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
to_date_arrow_button_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/button[4]'
to_date_month_list_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
...
def select_FromTo_date(browser, from_date, to_date):
    ...
    if now.year == from_date.year:
        if now.month == from_date.month:
            ...
            try:
                #click on month tab
                #from_date_month_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
                browser.find_element(by=By.XPATH, value = from_date_month_tab_click).click()
                time.sleep(2)
            except Exception as error:
        ...
        try:
            #click on year tab
            #from_date_year_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[2]'
            browser.find_element(by=By.XPATH, value = from_date_year_tab_click).click()
            time.sleep(2)
        except Exception as error:
        ...
        try:
            #click on month tab
            #from_date_month_tab_click1 = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
            browser.find_element(by=By.XPATH, value = from_date_month_tab_click1).click()
            time.sleep(2)
        except Exception as error:
                print('Month Tab is not available for the from_date')
    ...
    if from_date.year == to_date.year:
        try:
            ...
            #to_date_month_tab_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
            browser.find_element(by=By.XPATH, value = to_date_month_tab_click).click()
            time.sleep(2)
        except Exception as error:
        ...
        try:
            ...
            #to_date_arrow_button_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/button[4]'
            browser.find_element(by=By.XPATH, value = to_date_arrow_button_click).click()
            time.sleep(2)
        except Exception as error:
        ...
        if from_date.month == to_date.month:
            ...
            try:
                ...
                #to_date_month_list_click = '/html/body/div[2]/div/div/div/div/div[2]/div/div/div[1]/div/button[1]'
                browser.find_element(by=By.XPATH, value = to_date_month_list_click).click()
                time.sleep(2)
            except Exception as error:
