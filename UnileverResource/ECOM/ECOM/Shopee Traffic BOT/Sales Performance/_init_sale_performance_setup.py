...
# MAGIC %pip install /dbfs/FileStore/jars/9df82c93_cf23_40e1_bfb7_59e886501596/selenium-3.141.0-py2.py3-none-any.whl

# COMMAND ----------

chrome_driver_path = dbutils.notebook.run('/Shared/CHROME_DRIVER_SETUP', 30)
...
# Click Customize
browser.find_element(By.XPATH, "/html/body/div[3]/div/div/div/div[2]/div/div/ul/li[10]/span").click()
